...
    
### **Structured Speaking**  
  - Structured Speaking은 말의 구조를 스스로 구상할 수 있도록 문법과 숙어 표현 향상에 집중된 수업입니다.  
   
...
      ✅상황별 스피킹 – 직장 생활, 면접, 가정생활, 일상생활, 취미생활, 학교생활 등 실제 마주하는 다양한 상황에서 적절한 표현법을 배우고 연습하는 수업  
...
   
### **Business English**  
  - Business English는 비즈니스 미팅이나 프레젠테이션 같은 업무적인 주제들을 중심으로 이루어진 수업입니다.  
   
...
   
### **Power/Fluency**  
  - Power/Fluency는 일상생활을 하면서 경험할 수 있는 여러 상황에서 자유롭게 말하는 수업입니다.  
   
      ✅상황별 스피킹 – 직장 생활, 면접, 가정생활, 일상생활, 취미생활, 학교생활 등 실제 마주하는 다양한 상황에서 적절한 표현법을 배우고 연습하는 수업  
